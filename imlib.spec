...
Summary(fr):	Librairie de chargement et interprÈtation d'images pour X11R6
...
%description -l fr
Imlib est une librairie de remplacement avancÈe pour les librairies
comme libXpm qui fourni plus d'atouts et beaucoup plus de flexibilitÈ
et de vitesse.

%description -l pl
Imlib jest zaawansowanym zamiennikiem bibliotek typu libXpm, ze
zwiÍkszon± elastyczno∂ci± oraz prÍdko∂ci±.
...
Program imlib_config umoøliwia zmianÍ sposobu uøywania przez
bibliotekÍ imlib kolorÛw, korekcji gamma i innych.
